...
c){b[c]=e(a)}),k.pop(),b):k.yStack[f]}function c(a){var c=a.toString(),f=c.substring(c.indexOf("(")+1,c.indexOf(")")).trim().split(",");f.map(function(a,b,c){c[b]=a.trim()});c=c.substring(c.indexOf("{")+1,c.indexOf("}")).trim();f=new Function(f,c);return b(a,f)}function e(a){if(k.count>k.maxStackDepth)throw Error("Stack depth exceeded: "+k.stackMaxDepth+"!");switch(g.getType(a)){case g.types.object:return b(a,Object.create(a));case g.types.array:return b(a,[]);case g.types.regexp:return b(a,new RegExp(a));
...
f.pop();return!0}function e(a,b){if(f.count>f.maxStackDepth)throw Error("Stack depth exceeded: "+f.maxStackDepth+"!");if(a===b)return!0;var h=g.getType(a),d=g.getType(b);if(h!==d)return!1;var d=f.xStack.lastIndexOf(a),q=f.yStack.lastIndexOf(b);if(-1!==d&&-1!==q)return!0;switch(h){case g.types.date:if(a.getTime()!==b.getTime()||!c(a,b))return!1;break;case g.types["function"]:if(a.getBody()!==b.getBody()||!g.equals(a.getArgumentNames(),b.getArgumentNames())||!c(a,b))return!1;break;case g.types.array:if(a.length!==
b.length)return!1;f.push(a,b);for(h=0;h<a.length;h++)if(!e(a[h],b[h]))return!1;f.pop();break;case g.types.object:case g.types.regexp:if(!c(a,b))return!1;break;default:if(a!==b)return!1}return!0}var f=new d(1E3);return e(a,b)};g.extend=function(){var a=Array.prototype.slice.call(arguments);if(0>=a.length)return null;if(1===a.length)return a[0];for(var b=a[0],c=1;c<a.length;c++)g.assert.isSmashable(b,a[c]),g.forEach(a[c],function(e,f){g.check.exists(b[f])?g.check.isSmashable(b[f],a[c][f])&&(b[f]=g.smash(b[f],
a[c][f])):b[f]=a[c][f]});return b};g.forEach=function(a,b,c){switch(g.getType(a)){case g.types.object:case g.types.date:case g.types.regexp:case g.types["function"]:for(var e in a)a.hasOwnProperty(e)&&b.call(c,a[e],e);break;case g.types.array:for(e=0;e<a.length;e++)b.call(c,a[e],e)}return a};g.sizeof=function(a){var b=[];a=[a];for(var c=0;a.length;){var e=a.pop();if("boolean"===typeof e)c+=4;else if("string"===typeof e)c+=2*e.length;else if("number"===typeof e)c+=8;else if("object"===typeof e&&-1===
b.indexOf(e))for(i in b.push(e),e)a.push(e[i])}return c};g.smash=function(){var a=Array.prototype.slice.call(arguments);if(0>=a.length)return null;if(1===a.length)return a[0];var b=a[0],c=a[a.length-1];g.assert.isSmashable(b,c);g.forEach(c,function(a,e){g.check.isSmashable(b[e],c[e])?g.smash(b[e],c[e]):b[e]=g.deepCopy(c[e])});for(var e=a.length-2;1<=e;e--)g.assert.isSmashable(a[e],b),g.forEach(a[e],function(c,k){g.check.exists(b[k])?g.check.isSmashable(b[k],a[e][k])&&g.smash(b[k],a[e][k]):b[k]=g.deepCopy(a[e][k])});
return b};g.lambda=function(a){if(null==a)return g.functions.identity;if(g.getType(a)===g.types["function"])return a;if(g.getType(a)===g.types.string){if(g.equals(a,""))return g.functions.identity;if(-1<a.indexOf("=>")){var b=a.match(g.functions.matcher);return(new Function(b[1]||[],"return "+b[2]+";")).bind(arguments.callee.caller)}}return function(b){return g.equals(a,b)}};g.setup=function(a){a=a||{};g.setup.initArrays(a.useArrayExtensions);g.setup.initNumbers(a.useNumberExtensions);g.setup.initObjects(a.useObjectExtensions);
g.setup.initLogger(a.defaultLogger)};(function(){g.functions={identity:function(a){return a},"true":function(a){return!0},"false":function(a){return!1},empty:function(a){},matcher:/^(?:[(\s*]*)?(\w+(?:,\s*\w+)*)?(?:[)\s*]*)?=>(?:\s*)?(.*)$/};g.types={array:g.getType([]),"boolean":g.getType(!0),date:g.getType(new Date),"function":g.getType(function(){}),"null":g.getType(null),number:g.getType(0),object:g.getType({}),string:g.getType(""),regexp:g.getType(RegExp()),undefined:g.getType(a)}})()})();
...
0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++];return a.arrays.sum(c,b)/c.length};a.arrays.contains=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++],b=arguments[b++],f;f=a.check.isFunction(e)?function(a){return e(a)}:function(b,c){return a.equals(b,c)};if(null==b)for(var k=0;k<c.length;k++){if(f(c[k],e))return!0}else for(b=a.lambda(b),k=0;k<c.length;k++)if(f(b(c[k]),e))return!0;return!1};a.arrays.count=function(){var b=0,c=a.getType(this)===
a.types.array?this:arguments[b++],e=arguments[b++],b=arguments[b++],f=0,k;k=a.check.isFunction(e)?function(a){return e(a)}:function(b,c){return a.equals(b,c)};if(null==b)for(var d=0;d<c.length;d++)k(c[d],e)&&f++;else for(b=a.lambda(b),d=0;d<c.length;d++)k(b(c[d]),e)&&f++;return f};var d=function(){return a.deepCopy(this)};a.arrays.distinct=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=[];if(null==b)for(var f=0;f<c.length;f++)e.contains(c[f])||e.push(c[f]);
else for(b=a.lambda(b),f=0;f<c.length;f++)e.contains(b(c[f]),b)||e.push(c[f]);return e};var h=function(b){return a.equals(this,b)};a.arrays.first=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],c=this;if(null==b){if(0<c.length)return c[0]}else for(var b=a.lambda(b),e=0;e<c.length;e++)if(b(c[e]))return c[e];return null};a.arrays.innerJoin=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++];return{on:function(b){var k=[];
b=a.lambda(b);for(var d=0;d<c.length;d++){a.check.isObject(c[d]);for(var h=0;h<e.length;h++)a.check.isObject(e[h]),b(c[d],e[h])&&k.push(a.smash({},c[d],e[h]))}return k}}};a.arrays.isEmpty=function(){var b=0,b=a.getType(this)===a.types.array?this:arguments[b++];if(1>b.length)return!0;for(var c=0;c<b.length;c++)if(a.check.exists(b[c]))return!1;return!0};a.arrays.isFull=function(){var b=0,b=a.getType(this)===a.types.array?this:arguments[b++];if(1>b.length)return!1;for(var c=0;c<b.length;c++)if(!a.check.exists(b[c]))return!1;
...
a.check.isNumber(d)&&e<d&&(e=d);return e};a.arrays.min=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=Number.MAX_VALUE;if(null!=b)for(var b=a.lambda(b),f=0;f<c.length;f++){var d=b(c[f]);a.check.isNumber(d)&&d<e&&(e=d)}else for(f=0;f<c.length;f++)d=c[f],a.check.isNumber(d)&&d<e&&(e=d);return e};a.arrays.orderBy=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++],b=arguments[b++],e=a.lambda(e),b=b||function(a,b){return e(a)>
e(b)?1:e(a)<e(b)?-1:0},f=c.where(function(a){return null!=e(a)}),c=c.where(function(a){return null==e(a)});f.quicksort(b);return f.concat(c)};a.arrays.quicksort=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++],e=a.getType(e)===a.types.string?a.lambda(e):e||function(a,b){return a>b?1:a<b?-1:0},f=function(a,b){do{var d=a,h=b,g=c[Math.floor((a+b)/2)];do{for(;d<c.length&&0>e(c[d],g);)d++;for(;0<=h&&0>e(g,c[h]);)h--;if(d>h)break;d<h&&c.swap(d,h);d++;h--}while(d<=
h);h-a<=b-d?(a<h&&f(a,h),a=d):(d<b&&f(d,b),b=h)}while(a<b)};f(0,this.length-1)};a.arrays.quicksort3=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++],e=a.getType(e)===a.types.string?a.lambda(e):e||function(a,b){return a>b?1:a<b?-1:0},f=function(a,b){for(var d=a,h=b,g=c[a],p=a+1;p<=h;){var r=e(c[p],g);0>r?c.swap(d++,p++):0<r?c.swap(p,h--):p++}a<d-1&&f(a,d-1);h+1<b&&f(h+1,b)};f(0,this.length-1)};a.arrays.removeAll=function(){for(var b=0,c=a.getType(this)===a.types.array?
this:arguments[b++],b=arguments[b++],e=0,b=a.lambda(b),f=c.length-1;-1<f;f--)b(c[f])&&(c.splice(f,1),e++);return e};a.arrays.select=function(){for(var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=[],b=a.lambda(b),f=0;f<c.length;f++)e.push(b(c[f]));return e};a.arrays.skip=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=[];0>b&&(b=0);for(var f=0;f<c.length-b&&b<=c.length;f++)e[f]=c[f+b];return e};a.arrays.sum=function(){var b=
0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=0;if(null!=b)for(var b=a.lambda(b),f=0;f<c.length;f++){var d=b(c[f]);a.check.isNumber(d)&&(e+=d)}else for(f=0;f<c.length;f++)a.check.isNumber(c[f])&&(e+=c[f]);return e};a.arrays.swap=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],e=arguments[b++],b=arguments[b++],f=c[e];c[e]=c[b];c[b]=f};a.arrays.take=function(){var b=0,c=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=[];0>
...
arguments[b++],e=arguments[b++],b=arguments[b++],b=a.lambda(b),f=[],d=0;d<this.length;d++)f.push(b(c[d],e[d]));return f};a.setup.initArrays=function(b){b&&(a.defineProperty(Array.prototype,"aggregate",{enumerable:!1,writable:!1,value:a.arrays.aggregate}),a.defineProperty(Array.prototype,"any",{enumerable:!1,writable:!1,value:a.arrays.any}),a.defineProperty(Array.prototype,"average",{enumerable:!1,writable:!1,value:a.arrays.average}),a.defineProperty(Array.prototype,"contains",{enumerable:!1,writable:!1,
value:a.arrays.contains}),a.defineProperty(Array.prototype,"count",{enumerable:!1,writable:!1,value:a.arrays.count}),a.defineProperty(Array.prototype,"deepCopy",{enumerable:!1,writable:!1,value:d}),a.defineProperty(Array.prototype,"distinct",{enumerable:!1,writable:!1,value:a.arrays.distinct}),a.defineProperty(Array.prototype,"equals",{enumerable:!1,writable:!1,value:h}),a.defineProperty(Array.prototype,"first",{enumerable:!1,writable:!1,value:a.arrays.first}),a.defineProperty(Array.prototype,"innerJoin",
...
(function(a,g){a.classes=a.classes||{};var d=function(b,c){var e=arguments.callee.caller;if(a.getType(b)===a.types["function"]){if(!b()){if(c)throw Error(c);e=b.toString();e=e.substring(e.indexOf("{")+1,e.lastIndexOf("}")).trim();throw Error("Assertion failed: "+e);}}else if(a.getType(b)===a.types.string){if(b=a.lambda(b).bind(e),!b()){if(c)throw Error(c);e=b.toString();e=e.substring(e.indexOf("{")+1,e.lastIndexOf("}")).trim();throw Error("Assertion failed: "+e);}}else if(!b){if(c)throw Error(c);
throw Error("Assertion failed: "+String(b));}},h=function(){d(function(){return a.check.argsNotNull.apply(this,arguments)})},b=function(b){d(function(){return a.check.exists(b)})},c=function(b){d(function(){return a.check.isArray(b)})},e=function(b){d(function(){return a.check.isBoolean(b)})},f=function(b){d(function(){return a.check.isFunction(b)})},k=function(b){d(function(){return a.check.isNonEmptyArray(b)})},l=function(b){d(function(){return a.check.isNumber(b)})},m=function(b){d(function(){return a.check.isObject(b)})},
n=function(b){d(function(){return a.check.isReference(b)})},q=function(){var b=arguments;d(function(){return a.check.isSmashable.apply(g,b)})},p=function(b){d(function(){return a.check.isString(b)})},r=function(b,c){d(function(){return a.check.isType(b,c)})},t=function(b){d(function(){return a.check.isValue(b)})},u=function(){return function(){return function(d){a.defineProperty(d,"argsNotNull",{get:function(){return h},writeable:!1});a.defineProperty(d,"exists",{get:function(){return b},writeable:!1});
a.defineProperty(d,"isArray",{get:function(){return c},writeable:!1});a.defineProperty(d,"isBoolean",{get:function(){return e},writeable:!1});a.defineProperty(d,"isFunction",{get:function(){return f},writeable:!1});a.defineProperty(d,"isNonEmptyArray",{get:function(){return k},writeable:!1});a.defineProperty(d,"isNumber",{get:function(){return l},writeable:!1});a.defineProperty(d,"isObject",{get:function(){return m},writeable:!1});a.defineProperty(d,"isReference",{get:function(){return n},writeable:!1});
a.defineProperty(d,"isSmashable",{get:function(){return q},writeable:!1});a.defineProperty(d,"isString",{get:function(){return p},writeable:!1});a.defineProperty(d,"isType",{get:function(){return r},writeable:!1});a.defineProperty(d,"isValue",{get:function(){return t},writeable:!1});return d}(d)}}();a.classes.Asserter=u;a.assert=new a.classes.Asserter})(zUtil.prototype);
(function(a,g){var d=function(){};d.argsNotNull=function(){for(var a=0;a<arguments.length;a++)if(null==arguments[a])return!1;return!0};d.exists=function(a){return null!=a};d.isArray=function(d){return a.getType(d)===a.types.array};d.isBoolean=function(d){return a.getType(d)===a.types["boolean"]};d.isFunction=function(d){return a.getType(d)===a.types["function"]};d.isGeneratorFunction=function(d){return a.getType(d)===a.types["function"]&&d.isGenerator()};d.isIterable=function(d){return null==d?!1:
a.getType(d[a.symbols.iterator]||d.prototype[a.symbols.iterator])===a.types["function"]};d.isNonEmptyArray=function(d){return null!=d&&a.getType(d)===a.types.array&&0<d.length};d.isNumber=function(a){return!isNaN(a)};d.isObject=function(d){return a.getType(d)===a.types.object};d.isReference=function(d){switch(a.getType(d)){case a.types.array:case a.types.date:case a.types["function"]:case a.types.generator:case a.types.generatorFunction:case a.types.object:case a.types.regexp:return!0;default:return!1}};
d.isSmashable=function(){var d=Array.prototype.slice.call(arguments);if(1>d.length)return!1;var b=a.getType(d[0]);if(b!==a.types.array&&b!==a.types.object&&b!==a.types["function"])return!1;b===a.types["function"]&&(b=a.types.object);for(var c=1;c<d.length;c++){var e=a.getType(d[c]);e===a.types["function"]&&(e=a.types.object);if(e!==b)return!1}return!0};d.isString=function(d){return a.getType(d)===a.types.string};d.isType=function(d,b){return a.getType(d)===b};d.isValue=function(d){switch(a.getType(d)){case a.types["boolean"]:case a.types["null"]:case a.types.number:case a.types.string:case a.types.undefined:return!0;
default:return!1}};a.check=d})(zUtil.prototype);
(function(a,g){a.classes=a.classes||{};var d=function(c,d){a.assert.isString(d);switch(d){case a.types["boolean"]:return h(c);case a.types.number:return b(c)}},h=function(b){if(b&&a.check.isFunction(b.toBoolean))return b.toBoolean();switch(a.getType(b)){case a.types["boolean"]:return b;case a.types.string:switch(b.toLowerCase().trim()){case "false":case "0":case "":case null:case g:return!1;default:return!0}default:return!!b}},b=function(b){if(b&&a.check.isFunction(b.toNumber))return b.toNumber();switch(a.getType(b)){case a.types.number:return b;
default:return+b}},c=function(){return function(){return function(c){a.defineProperty(c,"toBoolean",{get:function(){return h},writeable:!1});a.defineProperty(c,"toNumber",{get:function(){return b},writeable:!1});return c}(d)}}();a.classes.Converter=c;a.convert=new a.classes.Converter})(zUtil.prototype);
...
writeable:!1});a.defineProperty(d,"clear",{get:function(){return c},writeable:!1});a.defineProperty(d,"on",{get:function(){return e},writeable:!1});return d}({})}}();a.classes.Events=d;a.events=new a.classes.Events})(zUtil.prototype);
(function(a,g){a.functions={};var d=function(){return a.deepCopy(this)},h=function(b,c){return a.defineProperty(this,b,c)},b=function(b){return a.equals(this,b)},c=function(){var b=Array.prototype.slice.call(arguments);b.unshift(this);return a.functions.extend.apply(null,b)};a.functions.extend=function(){return a.extend.apply(null,arguments)};a.functions.getArgumentNames=function(){var b=0,b=a.getType(this)===a.types.array?this:arguments[b++];assert.isFunction(b);b=s.substring(s.indexOf("(")+1,s.indexOf(")")).trim().split(",");
b.map(function(a,b,c){c[b]=a.trim()});return b};a.functions.getBody=function(){var b=0,b=a.getType(this)===a.types.array?this:arguments[b++];assert.isFunction(b);return b.toString().substring(b.indexOf("{")+1,b.indexOf("}")).trim()};var e=function(){var b=Array.prototype.slice.call(arguments);b.unshift(this);return a.functions.smash.apply(null,b)};a.functions.smash=function(){return a.smash.apply(null,arguments)};a.setup.initfunctions=function(f){f&&(a.defineProperty(Function.prototype,"deepCopy",
{enumerable:!1,writable:!1,value:d}),a.defineProperty(Function.prototype,"defineProperty",{enumerable:!1,writable:!1,value:h}),a.defineProperty(Function.prototype,"equals",{enumerable:!1,writable:!1,value:b}),a.defineProperty(Function.prototype,"extend",{enumerable:!1,writable:!1,value:c}),a.defineProperty(Function.prototype,"getArgumentNames",{enumerable:!1,writable:!1,value:getArgumentNames}),a.defineProperty(Function.prototype,"getBody",{enumerable:!1,writable:!1,value:getBody}),a.defineProperty(Function.prototype,
