...
return null};c.deepCopy=function(f){function a(b,a){d=l.xStack.indexOf(b);return-1===d?(l.push(b,a),c.forEach(b,function(b,d){a[d]=k(b)}),l.pop(),a):l.yStack[d]}function g(b){var d=function(){return b.apply(b,arguments)};c.forEach(b,function(b,e,l){d[e]=k(b)});return a(b,d)}function k(b){if(l.count>l.maxStackDepth)throw Error("Stack depth exceeded: "+l.stackMaxDepth+"!");switch(c.getType(b)){case c.types.object:return a(b,Object.create(b));case c.types.array:return a(b,[]);case c.types.regexp:return a(b,
new RegExp(b));case c.types.date:return a(b,new Date(b.toString()));case c.types.function:return g(b);default:return b}}var d=-1,l=new b(1E3);return k(f)};c.defineProperty=function(b,a,c){null==b[a]?Object.defineProperty(b,a,c):console.error("Error: the method "+a+" has already been defined on the following object: "+b)};c.equals=function(f,a){function g(b,e){if(b===e)return!0;var a=Object.keys(b),f=Object.keys(e);a.quicksort();f.quicksort();if(!k(a,f))return!1;d.push(b,e);for(var c in b)if(!k(b[c],
e[c]))return!1;d.pop();return!0}function k(b,e){if(d.count>d.maxStackDepth)throw Error("Stack depth exceeded: "+d.maxStackDepth+"!");if(b===e)return!0;var a=c.getType(b),f=c.getType(e);if(a!==f)return!1;var f=d.xStack.lastIndexOf(b),p=d.yStack.lastIndexOf(e);if(-1!==f&&-1!==p)return!0;switch(a){case c.types.date:if(b.getTime()!==e.getTime()||!g(b,e))return!1;break;case c.types.function:if(!g(b,e))return!1;break;case c.types.array:if(b.length!==e.length)return!1;d.push(b,e);for(a=0;a<b.length;a++)if(!k(b[a],
e[a]))return!1;d.pop();break;case c.types.object:case c.types.regexp:if(!g(b,e))return!1;break;default:if(b!==e)return!1}return!0}var d=new b(1E3);return k(f,a)};c.extend=function(){var b=Array.prototype.slice.call(arguments);if(0>=b.length)return null;if(1===b.length)return b[0];for(var a=b[0],g=1;g<b.length;g++)c.assert.isSmashable(a,b[g]),c.forEach(b[g],function(k,d){c.check.exists(a[d])?c.check.isSmashable(a[d],b[g][d])&&(a[d]=c.smash(a[d],b[g][d])):a[d]=b[g][d]});return a};c.forEach=function(b,
a,g){switch(c.getType(b)){case c.types.date:case c.types.function:case c.types.object:case c.types.regexp:for(var k in b)b.hasOwnProperty(k)&&a.call(g,b[k],k,b);break;case c.types.arguments:case c.types.array:for(k=0;k<b.length;k++)a.call(g,b[k],k,b)}return b};c.smash=function(){var b=Array.prototype.slice.call(arguments);if(0>=b.length)return null;if(1===b.length)return b[0];var a=b[0],g=b[b.length-1];c.assert.isSmashable(a,g);c.forEach(g,function(b,l){c.check.isSmashable(a[l],g[l])?c.smash(a[l],
g[l]):a[l]=c.deepCopy(g[l])});for(var k=b.length-2;1<=k;k--)c.assert.isSmashable(b[k],a),c.forEach(b[k],function(d,l){c.check.exists(a[l])?c.check.isSmashable(a[l],b[k][l])&&c.smash(a[l],b[k][l]):a[l]=c.deepCopy(b[k][l])});return a};c.lambda=function(b){if(null==b)return c.functions.identity;if(c.getType(b)===c.types.function)return b;if(c.getType(b)===c.types.string){if(c.equals(b,""))return c.functions.identity;if(-1<b.indexOf("=>")){var a=b.match(c.functions.matcher);return(new Function(a[1]||
