...
export default class Channel {
    ...
    */
    ...
    static unpipe(parent: Channel, ...channels: Array<Channel>) {
        ...
        if (parent.pipeline.length === 0 && parent.cancel)
            parent.cancel(); // don't spin the piping methods when no pipeline is attached?
    }
