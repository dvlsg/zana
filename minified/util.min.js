...
empty:function(a){},matcher:/^(?:[(\s*]*)?(\w+(?:,\s*\w+)*)?(?:[)\s*]*)?=>(?:\s*)?(.*)$/};d.types={array:d.getType([]),"boolean":d.getType(!0),date:d.getType(new Date),"function":d.getType(function(){}),"null":d.getType(null),number:d.getType(0),object:d.getType({}),string:d.getType(""),regexp:d.getType(RegExp()),undefined:d.getType(a)}})()})();console.log(window);
(function(a,d){console.log(a);a.arrays={};a.arrays.aggregate=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],b=arguments[b++];a.assert.isNonEmptyArray(e);for(var c=a.lambda(c),b=null==b?e[0]:c(b,e[0]),f=1;f<e.length;f++)b=c(b,e[f]);return b};a.arrays.any=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++];if(null==b)return 0<e.length;for(var b=a.lambda(b),c=0;c<e.length;c++)if(b(e[c]))return!0;return!1};a.arrays.average=
function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++];return a.arrays.sum(e,b)/e.length};a.arrays.contains=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],b=arguments[b++];if(null==b)for(var f=0;f<e.length;f++){if(a.equals(e[f],c))return!0}else for(b=a.lambda(b),f=0;f<e.length;f++)if(a.equals(c,b(e[f])))return!0;return!1};var g=function(){return a.deepCopy(this)};a.arrays.distinct=function(){var b=0,e=a.getType(this)===
a.types.array?this:arguments[b++],b=arguments[b++],c=[];if(null==b)for(var f=0;f<e.length;f++)c.contains(e[f])||c.push(e[f]);else for(b=a.lambda(b),f=0;f<e.length;f++)c.contains(b(e[f]),b)||c.push(e[f]);return c};var h=function(b){return a.equals(this,b)};a.arrays.first=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],e=this;if(null==b){if(0<e.length)return e[0]}else for(var b=a.lambda(b),c=0;c<e.length;c++)if(b(e[c]))return e[c];return null};a.arrays.innerJoin=
function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++];a.check.isNonEmptyArray(c);return{on:function(b){var k=[];b=a.lambda(b);for(var d=0;d<e.length;d++){a.check.isObject(e[d]);for(var h=0;h<c.length;h++)a.check.isObject(c[h]),b(e[d],c[h])&&k.push(a.smash(e[d],c[h]))}return k}}};a.arrays.last=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++];if(null==b){if(0<e.length)return e[e.length-1]}else for(var b=a.lambda(b),c=e.length-
1;0<=c;c--)if(b(e[c]))return e[c];return null};a.arrays.max=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],c=Number.MIN_VALUE;if(null!=b)for(var b=a.lambda(b),f=0;f<e.length;f++){var k=b(e[f]);a.check.isNumber(k)&&c<k&&(c=k)}else for(f=0;f<e.length;f++)k=e[f],a.check.isNumber(k)&&c<k&&(c=k);return c};a.arrays.min=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],c=Number.MAX_VALUE;if(null!=b)for(var b=a.lambda(b),f=
0;f<e.length;f++){var k=b(e[f]);a.check.isNumber(k)&&k<c&&(c=k)}else for(f=0;f<e.length;f++)k=e[f],a.check.isNumber(k)&&k<c&&(c=k);return c};a.arrays.orderBy=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],b=arguments[b++],c=a.lambda(c),b=b||function(a,b){return c(a)>c(b)?1:c(a)<c(b)?-1:0},f=e.where(function(a){return null!=c(a)}),e=e.where(function(a){return null==c(a)});f.quicksort(b);return f.concat(e)};a.arrays.quicksort=function(){var b=0,e=a.getType(this)===
a.types.array?this:arguments[b++],c=arguments[b++],c=a.getType(c)===a.types.string?a.lambda(c):c||function(a,b){return a>b?1:a<b?-1:0},f=function(a,b){do{var d=a,h=b,g=e[Math.floor((a+b)/2)];do{for(;d<e.length&&0>c(e[d],g);)d++;for(;0<=h&&0>c(g,e[h]);)h--;if(d>h)break;d<h&&e.swap(d,h);d++;h--}while(d<=h);h-a<=b-d?(a<h&&f(a,h),a=d):(d<b&&f(d,b),b=h)}while(a<b)};f(0,this.length-1)};a.arrays.quicksort3=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],c=a.getType(c)===
a.types.string?a.lambda(c):c||function(a,b){return a>b?1:a<b?-1:0},f=function(a,b){for(var d=a,h=b,g=e[a],p=a+1;p<=h;){var r=c(e[p],g);0>r?e.swap(d++,p++):0<r?e.swap(p,h--):p++}a<d-1&&f(a,d-1);h+1<b&&f(h+1,b)};f(0,this.length-1)};a.arrays.removeAll=function(){for(var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],c=0,b=a.lambda(b),f=e.length-1;-1<f;f--)b(e[f])&&(e.splice(f,1),c++);return c};a.arrays.select=function(){for(var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],
b=arguments[b++],c=[],b=a.lambda(b),f=0;f<e.length;f++)c.push(b(e[f]));return c};a.arrays.skip=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++];a.assert(function(){return 0<c&&c<=e.length});for(var b=[],f=0;f<e.length-c;f++)b[f]=e[f+c];return b};a.arrays.sum=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],c=0;if(null!=b)for(var b=a.lambda(b),f=0;f<e.length;f++){var d=b(e[f]);a.check.isNumber(d)&&(c+=d)}else for(f=0;f<
e.length;f++)a.check.isNumber(e[f])&&(c+=e[f]);return c};a.arrays.swap=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],b=arguments[b++],f=e[c];e[c]=e[b];e[b]=f};a.arrays.take=function(){var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++];a.assert(function(){return 0<c&&c<=e.length});for(var b=[],f=0;f<c;f++)b[f]=e[f];return b};a.arrays.takeWhile=function(){for(var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],
c=[],b=a.lambda(b),f=0;f<count&&b(e[f]);f++)c.push(e[f]);return c};a.arrays.where=function(){for(var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],b=arguments[b++],b=a.lambda(b),e=this,c=[],f=0;f<e.length;f++)b(e[f])&&c.push(e[f]);return c};a.arrays.zip=function(){for(var b=0,e=a.getType(this)===a.types.array?this:arguments[b++],c=arguments[b++],b=arguments[b++],b=a.lambda(b),f=[],d=0;d<this.length;d++)f.push(b(e[d],c[d]));return f};a.setup.initArrays=function(b){b&&(a.defineProperty(Array.prototype,
...
a.defineProperty(Array.prototype,"equals",{enumerable:!1,writable:!1,value:h}),a.defineProperty(Array.prototype,"first",{enumerable:!1,writable:!1,value:a.arrays.first}),a.defineProperty(Array.prototype,"innerJoin",{enumerable:!1,writable:!1,value:a.arrays.innerJoin}),a.defineProperty(Array.prototype,"last",{enumerable:!1,writable:!1,value:a.arrays.last}),a.defineProperty(Array.prototype,"max",{enumerable:!1,writable:!1,value:a.arrays.max}),a.defineProperty(Array.prototype,"min",{enumerable:!1,writable:!1,
...
writable:!1,value:a.arrays.where}),a.defineProperty(Array.prototype,"zip",{enumerable:!1,writable:!1,value:a.arrays.zip}))}})(zUtil.prototype);
